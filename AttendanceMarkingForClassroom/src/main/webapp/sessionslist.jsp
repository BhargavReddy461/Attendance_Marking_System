	...
	<div class="container bg">
		...
		<table class="table table-hover" style="font-size:24px">
			<tr class="table-info">
				...
				<th class="table-info">Add feedback form</th>
			</tr>
			<c:forEach items="${sessionlist}" var="l">
				<tr>
					<td><a href="updatesessiondetails?sessionId=${l.sessionId}">${l.sessionId}</a></td>
					<td>${l.sessionDesc}</td>
					<td>${l.skillSet}</td>
					<td>${l.sessionTime}</td>
					<td>${l.sessionDate}</td>
					<td>${l.availableSlots}</td>
					<td><a href="deletesessiondetails?sessionId=${l.sessionId}"><i class="fa fa-trash" style="color:red" aria-hidden="true"></i></td>
					<td><a href="addfeedbackform?sessionId=${l.sessionId}">feedback form</td>
				</tr>
			</c:forEach>
