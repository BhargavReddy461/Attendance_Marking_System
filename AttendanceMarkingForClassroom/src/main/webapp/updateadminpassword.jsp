	...
	<section id="hero" class="clearfix">
		<div class="container  h-100" style="margin-top: 100px">
			<div class="row justify-content-center align-self-center"
				...
				<div class="col-lg-6 intro-img order-lg-last order-first"
					style="margin-right: 0; padding-right: 0;margin-top:100px" data-aos="zoom-out"
					data-aos-delay="200">
					<form:form method="POST" modelAttribute="passwordForm"
						action="${contextPath}/passwordresetadmin" class="form-signin">
						<h1 class="form-signin-heading">Reset Password</h1>

						<spring:bind path="email">
							<div class="form-group ${status.error ? 'has-error' : ''}">
								<form:input type="text" path="email" class="form-control"
									placeholder="Email" readOnly="true" autofocus="true"></form:input>
						...
						<a href="${contextPath}/admin_login">${loginlink}</a>
					</form:form>
				</div>
			</div>
