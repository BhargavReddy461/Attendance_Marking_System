...
<body background="${contextPath}/resources/img/intro-bg.jpg">
	...
	<div class="container bg">
		...
		<table class="table table-hover" style="font-size:24px">
			<tr class="table-info">
				<th class="table-info">Trainer Id</th>
				<th class="table-info">Trainer name</th>
			...
			<c:forEach items="${trainerlist}" var="l">
				<tr>
					<td><a href="updatetrainerdetails?trainerId=${l.trainerId}">${l.trainerId}</a></td>
					<td>${l.trainerName}</td>
					<td>${l.contactNo}</td>
					<td>${l.traineremail}</td>
					<td>${l.skillset}</td>
					<td><a href="deletetrainerdetails?trainerId=${l.trainerId}">delete</td>
				</tr>
			</c:forEach>
