      ...
      <div class="row justify-content-center align-self-center" data-aos="fade-up">
        ...
        <div class="form-group ${error != null ? 'has-error' : ''}">
            ...
            <input name="username" type="text" class="form-control"  placeholder="Username"
                   ...
                   <h5 ><a href="${contextPath}/forgotadminusername">forgot username?</a></h5>
            <input name="password" type="password" class="form-control"  placeholder="Password"/>
            <span>${error}</span>
            <input type="hidden" name="${_csrf.parameterName}" value="${_csrf.token}"/>
            <h5 ><a href="${contextPath}/resetadminpassword">forgot password?</a></h5>

            <button class="btn btn-lg btn-primary btn-block" type="submit">Log In</button>
            <h4 class="text-center mt-3">Don't have one?  <a href="${contextPath}/admin_registration">Signup</a></h4>
        </div>
      </form>
    </div>
			</div>
