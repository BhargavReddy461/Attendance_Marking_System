...
<h4 class="text-center mt-5" style="font-size:35px; color:green">${yesmessage}</h4>
<h4 class="text-center mt-5" style="font-size:35px; color:red">${nomessage}</h4>

	<div class="container bg">

		<h1>Enrolled Sessions</h1>
		<table class="table table-hover" style="font-size:24px">
			<tr class="table-info">
				...
				<th class="table-info">mark attendance</th>
			</tr>
			<c:forEach items="${sessions}" var="l">
				<tr>
					<td>${l.sessionId}</td>
					<td>${l.sessionDesc}</td>
					
					<td><a href="markattendance?id=${l.id}">${l.attendance}</a></td> 
