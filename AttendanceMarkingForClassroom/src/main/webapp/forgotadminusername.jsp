...
<body background="${contextPath}/resources/img/intro-bg.jpg">
    ...
    <div class="container  h-100" style="margin-top:100px">
      <div class="row justify-content-center align-self-center" data-aos="fade-up">
        ...
        <img src="${contextPath}/resources/img/adminforgot.png" 
		alt="Attendance Marking Image" class="img-fluid">
        </div>

        <div class="col-lg-6 intro-img order-lg-last order-first" style="margin-right:0; padding-right:0;margin-top:100px" data-aos="zoom-out" data-aos-delay="200">
        <form:form method="POST" modelAttribute="forgotUsername" action="${contextPath}/forgotadminusername" class="form-signin">
           <h1 class="form-signin-heading">Forgot Username</h1>
            ...
            <spring:bind path="security2">
                <div class="form-group ${status.error ? 'has-error' : ''}">
                    <form:input type="text" path="security2" class="form-control" placeholder="Your primay school?"
                                autofocus="true"></form:input>
