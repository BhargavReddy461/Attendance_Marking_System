...
<body background="${contextPath}/resources/img/intro-bg.jpg">
	...
	<div class="container">
        ...
        <form:form method="POST" modelAttribute="feedbackformdone"  action="${contextPath}/addfeedbackform" class="form-signin">
            <h2 class="form-signin-heading">Feedback form</h2>
            <spring:bind path="sessionId">
                <div class="form-group ${status.error ? 'has-error' : ''}">
                    <form:input type="number" path="sessionId" class="form-control" placeholder="Session Id" value="${sessionId}" readOnly="true"
                                autofocus="true"></form:input>
                    <form:errors path="sessionId"></form:errors>
                </div>
            </spring:bind>
            <spring:bind path="feedbackform">
                <div class="form-group ${status.error ? 'has-error' : ''}">
                    <form:input type="text" path="feedbackform" class="form-control" placeholder="Enter Feedback Question "
                                autofocus="true"></form:input>
                    <form:errors path="feedbackform"></form:errors>
                </div>
            </spring:bind>
...
<a href="${contextPath}/sessionslist" class="btn btn-secondary">Back to Sessions</a> 
