...
<body background="${contextPath}/resources/img/intro-bg.jpg">
	...
	<div class="container bg">
		...
		<table class="table table-hover" style="font-size:24px">
			<tr class="table-info">
				<th class="table-info">User Id</th>
				<th class="table-info">Feedback</th>
				
			</tr>
			<c:forEach items="${enrolleduserlist}" var="l">
				<tr>
					<td>${l.userId}</td>
					<td>${l.feedback}</td>
		...
		<a href="${contextPath}/sessionsreportsadmin" class="btn btn-secondary">Back to Sessions</a> 
	</div>
