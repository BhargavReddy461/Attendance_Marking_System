...
<body background="${contextPath}/resources/img/intro-bg.jpg">
	...
	<div class="container">
		<h1>Notifications</h1>
		<br> ${message }
		<c:forEach items="${notifs}" var="l">
			<br>
			<hr>
			<a href="deletenotifs?id=${l.id }">remove</a>
			<br>
			<br>
			<h3>
				You have enrolled for a session on <strong>${l.sessionDesc }</strong>
			</h3>
			<h5>The status of the session is ${l.status }.</h5>
${sessionTimer}
<br>
			<br>
		</c:forEach>
