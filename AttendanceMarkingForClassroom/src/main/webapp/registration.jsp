		...
		<div class="container h-100" style="margin-top:100px">
			<div class="row " data-aos="fade-up">
				<div class="col-lg-6 intro-img order-lg-last order-first"
					...
					<img src="${contextPath}/resources/img/registration.png"
						alt="Attendance Marking Image" class="img-fluid"
						style="max-width: 200%; margin-top: 100px; margin-left: 100px;">
				</div>

				<div class="col-lg-6 intro-img order-lg-last order-first"
					style="margin-right: 0; margin-top: 40px; padding-right: 0"
					data-aos="zoom-out" data-aos-delay="200">
				...
				<spring:bind path="passwordConfirm">
					<div class="form-group col-md-6 ${status.error ? 'has-error' : ''}">
						<form:input type="password" path="passwordConfirm"
							class="form-control" placeholder="Pass Confirm "></form:input>
			...
			<spring:bind path="security2">
				<div class="form-group ${status.error ? 'has-error' : ''}">
					<form:input type="text" path="security2" class="form-control"
						placeholder="Your primary school?" autofocus="true"></form:input>
