...
<nav class="navbar home-navbar navbar-expand-sm ">
    ...
    <div class="container  h-100" style="margin-top:20px">
      <div class="row justify-content-center align-self-center"  data-aos="fade-up">
        <div class="col-lg-6 intro-img order-lg-last order-first" data-aos="zoom-out" style="margin-top:200px" data-aos-delay="200">
        <img src="${contextPath}/resources/img/adminlogin.png" 
		alt="Attendance Marking Image" class="img-fluid">
        </div>

        <div class="col-lg-6 intro-img order-lg-last order-first" style="margin-right:0; padding-right:0" data-aos="zoom-out" data-aos-delay="200">
        <form:form method="POST" modelAttribute="adminForm" class="form-signin">
            ...
            <spring:bind path="contact">
                <div class="form-group ${status.error ? 'has-error' : ''}">
                    <form:input type="number" path="contact" class="form-control" placeholder="Contact Number"
                                autofocus="true"></form:input>
            ...
            <spring:bind path="passwordConfirm">
                <div class="form-group col-lg-6 ${status.error ? 'has-error' : ''}">
                    <form:input type="password" path="passwordConfirm" class="form-control"
                                placeholder="Pass Confirm"></form:input>
            ...
            <spring:bind path="security1">
                <div class="form-group ${status.error ? 'has-error' : ''}">
                    <form:input type="text" path="security1" class="form-control" placeholder="What is your first pet name?"
                                autofocus="true"></form:input>
            ...
            <spring:bind path="security2">
                <div class="form-group ${status.error ? 'has-error' : ''}">
                    <form:input type="text" path="security2" class="form-control" placeholder="Your primary school?"
                                autofocus="true"></form:input>
            ...
            <h4 class="text-center mt-3">Already registered ?  <a href="${contextPath}/admin_login">Login</a></h4>
        </form:form>
    </div>
			</div>
