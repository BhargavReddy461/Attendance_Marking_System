...
<body background="${contextPath}/resources/img/intro-bg.jpg">
	...
	<div class="container">
        ...
        <form:form method="POST" modelAttribute="skill"  action="/addskills" class="form-signin">
            <h2 class="form-signin-heading">Add Skill Details</h2>
            <spring:bind path="skillType">
                <div class="form-group ${status.error ? 'has-error' : ''}">
                    <form:input type="text" path="skillType" class="form-control" placeholder="Skill Type"
                                autofocus="true"></form:input>
                    <form:errors path="skillType"></form:errors>
                </div>
            </spring:bind>
            <spring:bind path="skillDesc">
                <div class="form-group ${status.error ? 'has-error' : ''}">
                    <form:input type="text" path="skillDesc" class="form-control" placeholder="SkillDesc"
                                autofocus="true"></form:input>
                    <form:errors path="skillDesc"></form:errors>
                </div>
            </spring:bind>
