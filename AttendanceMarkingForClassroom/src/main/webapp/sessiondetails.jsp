		...
		<div class="container">
			...
			<ul class="navbar-nav">
				...
				<li class="nav-item dropdown"><a class="nav-link"
					...
					href="/usernotification?userId=${ruser.id }">notifications</a></li>
				<li class="nav-item dropdown"><a href="#"
					class="nav-link dropdown-toggle" style="font-size: 24px"
	...
	<div class="container bg">
		...
		<table class="table table-hover" style="font-size:24px">
			...
			<tr class="table-info">
				...
				<th class="table-info">Session Time</th>
				<th class="table-info">Session Date</th>
				<th class="table-info">Available Slots</th>
				<th class="table-info">Enroll For a Session</th>
			</tr>
			
			<tr >
				<td>${session.sessionId}</td>
				<td>${session.sessionDesc}</td>
				<td>${session.skillSet}</td>
				<td>${session.sessionTime}</td>
				<td>${session.sessionDate}</td>
				<td>${session.availableSlots}</td>
				<td><a href="enroll?sessionId=${session.sessionId }">Enroll</a></td>
				
			</tr>
		</table>
		<a href="${contextPath}/viewsessiondetails" class="btn btn-secondary">Back to Sessions</a> 
		 <h4 class="text-center mt-5" style="font-size:35px; color:green">${message}</h4>
		  <h4 class="text-center mt-5" style="font-size:35px; color:red">${alreadymessage}</h4>
	</div>
