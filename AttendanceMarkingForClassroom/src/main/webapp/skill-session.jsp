...
<body background="${contextPath}/resources/img/intro-bg.jpg">
	...
	<div class="container">
        ...
        <form:form method="POST" modelAttribute="skill-session"  action="/skillsessionmapping" class="form-signin">
            <h2 class="form-signin-heading">Skill-Session Mapping</h2>
            <spring:bind path="skillId">
                <div class="form-group ${status.error ? 'has-error' : ''}">
                    <form:input type="text" path="skillId" class="form-control" placeholder="Skill Id"
                                autofocus="true"></form:input>
                    <form:errors path="skillId"></form:errors>
                </div>
            </spring:bind>
            <spring:bind path="sessionId">
                <div class="form-group ${status.error ? 'has-error' : ''}">
                    <form:input type="text" path="sessionId" class="form-control" placeholder="Session Id"
                                autofocus="true"></form:input>
